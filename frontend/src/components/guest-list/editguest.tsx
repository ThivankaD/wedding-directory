      ...
      <div className="bg-white dark:bg-darkSurface rounded-3xl border-2 border-orange/20 shadow-2xl p-6 sm:p-8 max-w-lg w-full animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between pb-4 mb-5 border-b border-orange/15 dark:border-zinc-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold font-title text-gray-900 dark:text-zinc-100">Edit Guest</h2>
              <p className="text-xs text-gray-500 dark:text-zinc-400 font-body">Update details for {guest.name}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="sm:col-span-2">
              ...
              <input
                type="text"
                className="w-full h-11 px-3.5 border-2 border-gray-200 dark:border-zinc-700 rounded-xl bg-gray-50 dark:bg-darkElevated text-sm font-semibold text-gray-500 dark:text-zinc-400 cursor-not-allowed"
                value={formData.name}
                disabled
              />
            </div>
