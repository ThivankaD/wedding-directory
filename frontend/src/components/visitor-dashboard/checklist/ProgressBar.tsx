  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-between items-center text-xs sm:text-sm font-body">
        <span className="font-bold text-gray-700 uppercase tracking-wider text-xs">Overall Progress</span>
        <span className="font-bold text-orange font-title text-base sm:text-lg">{progress}% Complete</span>
      </div>
      <div className="w-full bg-orange/10 rounded-full h-3 overflow-hidden p-0.5 border border-orange/20">
        <div
      ...
      <div className="flex justify-between items-center text-xs text-gray-500 font-body">
