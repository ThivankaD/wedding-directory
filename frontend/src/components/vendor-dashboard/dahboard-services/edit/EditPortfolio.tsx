                    ...
                    <div
                      className={`aspect-square w-full border-2 rounded-xl flex flex-col justify-center items-center relative overflow-hidden transition-all duration-200 ${
                        preview
                          ...
                          : "border-dashed border-gray-300 dark:border-zinc-700 hover:border-orange bg-gray-50 dark:bg-darkElevated hover:bg-gray-100 dark:hover:bg-darkElevated/70 cursor-pointer"
                      }`}
                    >
                      <input
                        type="file"
