  ...
  return (
    <div className="bg-white dark:bg-darkSurface rounded-2xl shadow-sm border border-gray-100 dark:border-zinc-800 p-6 sm:p-8">
      <div className="pb-6 mb-6 border-b border-gray-100 dark:border-zinc-800">
        <h2 className="font-title text-2xl font-bold text-gray-900 dark:text-zinc-100">General Information</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 font-body">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3.5 py-2.5 text-sm rounded-lg border border-gray-300 dark:border-zinc-700 bg-white dark:bg-darkElevated focus:border-orange focus:ring-2 focus:ring-orange/20 outline-none transition-all resize-y text-gray-800 dark:text-zinc-100 placeholder:text-gray-400 dark:placeholder:text-zinc-500"
          />
